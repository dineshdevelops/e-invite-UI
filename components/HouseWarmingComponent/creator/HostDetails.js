...
export function HostPreview({houseWarmingData,setHouseWarmingData,hostDetail}){
  const removeHost=(hostName)=>{
    ...
    setHouseWarmingData({...houseWarmingData,hostDetails:updatedHostDetails})
  }
  return(
...
const HostDetails = ({houseWarmingData,setHouseWarmingData}) => {
  ...
  const handleHost = ()=>{
    ...
    houseWarmingData.hostDetails.push(hostDetails);
    setHostDetails({
      hostName:"",
      hostQualification:"",
      hostJob:""
    ...
    <div className={styles.hostDetails}>
      ...
      <div className={styles.bottom}>
        ...
        <div className={styles.eventsPreview}>
            {houseWarmingData.hostDetails.map((hostDetail,index)=>(
                <HostPreview key={index} hostDetail={hostDetail} houseWarmingData={houseWarmingData} setHouseWarmingData={setHouseWarmingData} />
            ))}
        </div>
      </div>
    </div>
